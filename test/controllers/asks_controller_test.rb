...
class AsksControllerTest < ActionController::TestCase
  ...
  test "should create ask" do
    assert_difference('Ask.count') do
      post :create, ask: { ask: @ask.ask, details: @ask.details, event_id: @ask.event_id, user_id: @ask.user_id }
    end
  ...
  test "should update ask" do
    patch :update, id: @ask, ask: { ask: @ask.ask, details: @ask.details, event_id: @ask.event_id, user_id: @ask.user_id }
    assert_redirected_to ask_path(assigns(:ask))
  end
